...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            self.epsilon = self.epsilon * (self.cnt**-0.01)
            self.cnt +=1
    ...
    def createQ(self, state):
        ...
        if self.learning: 
            if not state in self.Q.keys():
                self.Q[state]={}
                for i in [None, 'forward', 'left', 'right']: self.Q[state][i]=0.0
    ...
    def choose_action(self, state):
        ...
        if not self.learning: 
            ...
            if random.random() <= self.epsilon:
                ...
                actions = [key for key,value in self.Q[state].items() if value==maxQ]
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, alpha= 0.02, epsilon =1)
